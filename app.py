...
def main():
    ...
    st.header("Commentary AI :dolphin:")
    st.text("Provide voice over to your videos")
    st.text("Limit the duration of your videos to less than 10 seconds")
    uploaded_file = st.file_uploader("Choose a file")

    if uploaded_file is not None:
        st.video(uploaded_file)
        prompt = st.text_area(
            "Prompt", value="Provide a voiceover script for this!")
